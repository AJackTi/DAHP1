...
JButton btButton, btnExit;
	...
	public buildGUI()
	{
		...
		p5.add(label = new JLabel("Results: "));
		area = new JTextArea(10, 57);
		scroll = new JScrollPane (area);
		scroll.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
		area.setEditable(true);
		p5.add(scroll);
		lbJLabel.setPreferredSize(label.getPreferredSize());
		
		
		p6.add(btnExit = new JButton("Exit"));
